             ...
             <div class="row">
                 <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                     <div class="jp_newsletter_text">
                         <img src="{{asset('assets/site/images/content/news_logo.png')}}" class="img-responsive" alt="news_logo" />
                     </div>
                 </div>
                 <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                     <div class="jp_newsletter_field">
                         <i class="fa fa-envelope-o"></i><input type="text" placeholder="Enter Your Email"><button
                 ...
                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     <div class="jp_footer_logo_wrapper">
                         <div class="jp_footer_logo">
                             <a href="#"><img src="{{asset('assets/site/images/content/resume_logo.png')}}" alt="footer_logo" /></a>
                         </div>
                     </div>
                 </div>
                         ...
                         <div class="jp_footer_first_cont_wrapper">
                             <div class="jp_footer_first_cont">
                                 ...
                                 <p>This is Photoshop's version of Lom Ipsum. Proin gravida nibh vel velit auctor
                                     aliquet. Aenean sollicitudin, lorem quis bibendum.<br><br> Proin akshay handge
                         ...
                         <div class="row">
                             <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                 <div class="jp_bottom_footer_left_cont">
                                     <p>© 2021 Resource Right. All Rights Reserved.</p>
                                 </div>
 ...
 <!--main js file start-->
 <script src="{{asset('assets/site/js/jquery_min.js')}}"></script>
 <script src="{{asset('assets/site/js/bootstrap.js')}}"></script>
 <script src="{{asset('assets/site/js/jquery.menu-aim.js')}}"></script>
 <script src="{{asset('assets/site/js/jquery.countTo.js')}}"></script>
 <script src="{{asset('assets/site/js/jquery.inview.min.js')}}"></script>
