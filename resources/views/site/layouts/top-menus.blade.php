        ...
        <div class="row">
            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 hidden-xs hidden-sm full_width">
                <div class="gc_header_wrapper">
                    <div class="gc_logo">
                        <a href="index.html"><img src="{{asset('assets/site/images/header/logo.png')}}" alt="Logo"
                                title="Resource Right" class="img-responsive"></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-7 col-md-8 col-sm-12 col-xs-12 center_responsive">
                <div class="header-area hidden-menu-bar stick" id="sticker">
                    ...
                    <div class="mainmenu">
                            ...
                            <ul>
                                <li id="search_button">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        version="1.1" id="Capa_3" x="0px" y="0px" viewBox="0 0 451 451"
                        ...
                        <ul class="float_left">
                            <li class="has-mega gc_main_navigation"><a href="{{route('site.home')}}"
                                    class="gc_main_navigation">
                                    Home</a>

                            </li>
                            <li class="has-mega gc_main_navigation"><a href="{{route('site.about')}}"
                                    class="gc_main_navigation">
                                    About Us</a>
                            ...
                            <li class="has-mega gc_main_navigation"><a
                                    href="{{route('site.recruiter.vacancies.create')}}" class="gc_main_navigation">
                                    Job</a>

                            </li>
                            <li class="parent gc_main_navigation"><a href="#" class="gc_main_navigation">Career
                                    Advice</a>
                            </li>
                            <li class="has-mega gc_main_navigation"><a href="#" class="gc_main_navigation">
                                    Work For Us</a>
                            ...
                            <li class="gc_main_navigation parent"><a href="{{route('site.contact')}}"
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-xs-6 col-sm-6">
                                    <div class="gc_logo">
                                        <a href="index.html"><img src="{{asset('assets/site/images/header/logo.png')}}"
                                            ...
                                            <ul class="cd-dropdown-content">
                                                ...
                                                <li class="has-children">
                                                    ...
                                                    <ul class="cd-secondary-dropdown is-hidden">
                                                        ...
                                                        <li><a
                                                                href="{{route('site.recruiter.vacancies.create')}}">Add-Posting</a>
                                                        </li>
                                                        <li><a href="{{route('site.auth.sign-in')}}">Login</a></li>
                                                ...
                                                <li>
                                                    <a href="register.html">Register CV</a>
                                                </li>
                                                <li>
                                                    <a href="{{route('site.auth.sign-in')}}">Login</a>
                                                </li>
            ...
            <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12 hidden-sm hidden-xs">
                <div class="jp_navi_right_btn_wrapper">
                    <ul>
                        ...
                        @if (auth()->guard('candidate')->check() || auth()->guard('recruiter')->check())
                        <li><a href="{{route('site.auth.sign-out')}}"><i class="fa fa-sign-out"></i>&nbsp; LOGOUT</a>
                        </li>
                        @else
                        <li><a href="register.html"><i class="fa fa-user"></i>&nbsp; Register CV</a></li>
                        <li><a href="{{route('site.auth.sign-in')}}"><i class="fa fa-sign-in"></i>&nbsp; LOGIN</a></li>
                        @endif
