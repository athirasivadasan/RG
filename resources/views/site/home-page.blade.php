                    ...
                    <div class="item">
                        <div class="jp_tittle_slides_one">
                            <div class="jp_tittle_side_img_wrapper">
                                <img src="{{asset('assets/site/images/content/tittle_img1.png')}}" alt="tittle_img" />
                            </div>
                        ...
                        <div class="jp_tittle_slides_one jp_tittle_slides_two">
                            <div class="jp_tittle_side_img_wrapper">
                                <img src="{{asset('assets/site/images/content/tittle_img2.png')}}" alt="tittle_img" />
                            </div>
                            <div class="jp_tittle_side_cont_wrapper">
                                <h4>Graphic Designer (UI / UX)</h4>
                                <p>Webstrot Pvt. Ltd.</p>
                        ...
                        <div class="jp_tittle_slides_one jp_tittle_slides_third">
                            <div class="jp_tittle_side_img_wrapper">
                                <img src="{{asset('assets/site/images/content/tittle_img3.png')}}" alt="tittle_img" />
                            </div>
                            <div class="jp_tittle_side_cont_wrapper">
                                <h4>Graphic Designer (UI / UX)</h4>
                                <p>Webstrot Pvt. Ltd.</p>
    ...
    <div class="container">
        ...
        <div class="gc_counter_cont_wrapper2">
            <div class="count-description">
                ...
                <h5 class="con2">Placements Made </h5>
            </div>
        </div>
        <div class="gc_counter_cont_wrapper3">
            <div class="count-description">
                <span class="timer">1924</span><i class="fa fa-plus"></i>
                <h5 class="con3">Total Resumes</h5>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 hidden-sm hidden-xs">
                <div class="jp_down_mob_img_wrapper">
                    <img src="{{asset('assets/site/images/content/mobail.png')}}" alt="mobail_img" />
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 visible-sm visible-xs">
                <div class="jp_down_mob_img_wrapper">
                    <img src="{{asset('assets/site/images/content/mobail.png')}}" class="img-responsive"
                        alt="mobail_img" />
                </div>
            </div>
        </div>
